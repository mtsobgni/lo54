                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <%} else { %>
                                <input id="s" value="<%=request.getAttribute("keyword")%>" type="text"
                                       placeholder="recherche" name="s" class="form-control left-rounded">
                                <% } %>
                                <div class="input-group-btn">
                                    <button type="submit" id="rec" class="btn btn-inverse right-rounded">Chercher
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div id="lo" class="w3-container">
                <table style="width:750px" class="w3-table-all w3-hoverable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ServletSession?code=<%=c.getCode()%>&titre=<%=c.getTitle()%>&date=<%=date%>&lieu=<%=lieu%>">S'inscrire
                                à une session </a></td>
                    </tr>
                    <%}%>
                </table>

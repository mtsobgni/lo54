                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <input id="keyword" value=${keyword} type="text" placeholder="recherche" name="keyword" class="form-control left-rounded">
                                    </c:otherwise>
                                </c:choose>
                ...
                <table style="width:750px" class="w3-table-all w3-hoverable">
                    ...
                    <c:forEach items="${ list }" var="course" varStatus="status">
                        <tr>
                            ...
                            <td><a href="ServletSession?code=${ course[0] }&titre=${ course[1] }&date=${ date }&lieu=${ lieu }">S'inscrire à une session </a></td>
                        </tr>
                    </c:forEach>
                </table>
                </c:otherwise>
